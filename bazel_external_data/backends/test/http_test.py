...
class HttpTest(unittest.TestCase):
    ...
    def test_file_lifecycle(self):
        ...
        hash = hashes.sha512.compute(local_file)
        print(f"hash for {local_file} is {hash}.")
        self.assertFalse(dut.check_file(hash, file_in_project))
        dut.upload_file(hash, file_in_project, local_file)
        self.assertTrue(dut.check_file(hash, file_in_project))
        os.remove(local_file)
        dut.download_file(hash, file_in_project, local_file)
    ...
    def test_repo_credentials(self):
        ...
        project_config["remotes"]["unit_test_remote"]["api-key"] = "repo_key"
    ...
    def test_unauthorized(self):
        ...
        with self.assertRaises(AssertionError):
            dut.check_file(hash, file_in_project)
